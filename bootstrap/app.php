...
$app->routeMiddleware([
    'ValidateDataMiddleware' => App\Http\Middleware\ValidateDataMiddleware::class,
]);
...
$app->register(App\Providers\CategoryServiceProvider::class);
$app->register(App\Providers\ProductServiceProvider::class);
$app->register(App\Providers\BrandServiceProvider::class);
